import { CurrencyAmount, ETHER, Percent, Route, TokenAmount, Trade } from '@trustevm/sdk-tlos'
...
describe('v1SwapArguments', () => {
  ...
  const DAI_WETH = new MockV1Pair('1000000', new TokenAmount(flexUSD, '1000000'))
